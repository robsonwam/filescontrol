package br.ufpe.cin.sd.model.persistence.dao;
...
import br.ufpe.cin.sd.util.EntityManagerFactoryCreate;
...
public abstract class GenericDAO<T> implements IRegister<T> {
	...
	/*
	 * Digamos que voc� tenha recuperado sua lista de cidades como: 
	 * List<Cidade> cidades = query.list();  
	 * e que a classe Cidade tenha o campo "nome". Para ordenar voc� mesmo (sem depender do banco de dados) as cidades recebidas, voc� pode usar: 
	...
	/**
	 * * Atualiza o objeto que se encontra em mem�ria. * * @param object *
	...
	/**
	 * * Executa o merge do objeto que se encontra em mem�ria. * * @param objeto
	...
	/**
	 * * Remove o objeto uma vez passado sua chave como par�metro. * * @param
	...
	/**
	 * * Busca o objeto uma vez passado sua chave como par�metro. * * @param
	 ...
	 * ordenacoes * lista de crit�rios de ordena��o * @return Lista de objetos
	 * retornada
	 */
...
//		session.setCacheMode(CacheMode.REFRESH);
	 ...
	 * indiceFinal * @param ordenacoes * lista de crit�rios de ordena��o. * @return
	 * Lista de orden
	 */
	...
	/**
	 * * Busca todos os objetos para aquela entidade espec�fica. * * @param
	 * ordenacoes * lista de ordena��es para pesquisa * @return lista de todos
	...
	/**
	 * * * Busca todos os objetos de uma entidade espec�fica de um �ndice
	 * inicial * at� um �ndice final. * * @param indiceInicial * indice inicial
	 * da busca * @param indiceFinal * indice final da pesquisa. * @param
	 * ordenacoes * lista de ordena��o a ser criado * @return uma lista de
	 * objetos do tipo T
	 */
	 ...
	 * * gen�rico. * * @return Entity manager.
	 */
...
//		session.setCacheMode(CacheMode.REFRESH);
	 ...
	 * Example ser� criado * @return em objeto do tipo Example
	 */
